...
namespace MultiplayerSFS.Mod
{
    public class Main : ModLoader.Mod// ! , IUpdatable
    {
        ...
        public override string DisplayName => "SFS New World";
        public override string Author => "Allsh";
        public override string MinimumGameVersionNecessary => "1.5.10.2";
        public override string ModVersion => "1.0";
        public override string Description => "Going into NEW SFS WORLD with your friends! This mod adds multiplayer functionality to SFS New World. ";
